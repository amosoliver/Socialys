            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white" href="{{ route('congregacaos.index') }}">Congregações</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li>
                                    <a class="dropdown-item" href="{{ route('recibos.index') }}">Entrada</a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('recibos.saida.index') }}">Saida</a>
                                </li>
                            </ul>
                        </li>
