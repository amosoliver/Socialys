<tr><td style="width:258pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
    bgcolor="#808080">
    <p class="s5"
        style="padding-top: 2pt;padding-left: 107pt;padding-right: 106pt;text-indent: 0pt;text-align: center;">
        TOTAL</p>
</td>
<td
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <h3 style="padding-top: 4pt; text-align: center;">IGREJA EVANGÉLICA ASSEMBLÉIA DE DEUS</h3>
            <p style="line-height: 128%; text-align: center;"> <img width="116" height="104"
                ...
                Rua Pastor Messias Barbosa, nº 3200, Tiradentes - CEP: 76.824-568 <img width="131" height="103"
            ...
            <p style="line-height: 128%; text-align: center;"> Porto Velho - RO / CNPJ: 04.416.467/0001-78 </p>
            <p style="text-align: center;">Fone: (69) 3221-0013</p>
            <p style="text-align: center;"> <a href="mailto:iead-pvh@hotmail.com" class="a"
                    target="_blank">www.ieadpvh.com / </a> <a href="mailto:iead-pvh@hotmail.com"
        ...
        <p><br></p>
        <h1 style="text-align: center;">RESUMO FINANCEIRO SEMANAL</h1>
    </div>
    <div class="col-md-4"> </div>
</div>
</div>
<table style="text-align: center; border-collapse: collapse; margin: 0 auto;" cellspacing="0">
    <tr style="height:24pt">
        <td style="width:512pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
            colspan="5" bgcolor="#808080">
            <p class="s3"
                style="padding-left: 68pt;padding-right: 66pt;text-indent: 0pt;line-height: 23pt;text-align: center;">
                Total de Entradas (Dízimos e Ofertas)</p>
        </td>
    </tr>
    <tr style="height:15pt">
        <td
            ...
            <p class="s4" style="padding-top: 1pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">Nº RECIBO
            </p>
        </td>
        <td
        ...
        <td
            ...
            <p class="s4" style="padding-left: 107pt;padding-right: 105pt;text-indent: 0pt;text-align: center;">
                NOME</p>
        </td>
        <td
            style="width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
            <p class="s4" style="padding-top: 1pt;padding-left: 21pt;text-indent: 0pt;text-align: left;">VALOR </p>
        </td>
    </tr>
    @foreach ($recibosTipo1 as $recibo1)
        <tr style="height:17pt">
            <td
                style="width:58pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br /> {{ $recibo1->numero_recibo }} </p>
            </td>
            <td
                style="width:66pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibo1->descricao }}</p>
            </td>
            <td
                style="width:56pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
            ...
            <td
                style="width:258pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibo1->nome }}</p>
            </td>
            <td
                style="width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibo1->valor }}</p>
            </td>
        </tr>

        @endforeach <tr style="height:24pt">
            <td style="width:180pt;border-top-style:solid;border-top-width:1pt;border-right-style:solid;border-right-width:1pt"
                colspan="3">
                <p style="text-indent: 0pt;text-align: left;"><br /></p>
            </td>
            ...
            <td
                style="width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibosTipo1Total }}</p>
            </td>
        </tr>
</table>
<p style="text-indent: 0pt;text-align: left;"><br /></p>
<p style="padding-top: 2pt;padding-left: 81pt;text-indent: 0pt;text-align: left;"><span
        style=" color: #FFF; font-family:Arial, sans-serif; font-style: normal; font-weight: bold; text-decoration: none; font-size: 14pt;">SALDO
        DOS 30%</span></p>
<p style="padding-left: 185pt;text-indent: 0pt;text-align: left;" />
<table style="text-align: center; border-collapse: collapse; margin: 0 auto;" cellspacing="0">
    <tr style="height:24pt">
        <td style="width:512pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
            colspan="5" bgcolor="#808080">
            <p class="s3"
                style="padding-left: 68pt;padding-right: 66pt;text-indent: 0pt;line-height: 23pt;text-align: center;">
                Total de Entradas (Missão, Literaturas e Votos)</p>
        </td>
    </tr>
    <tr style="height:15pt">
        <td
        ...
        <td
            style="width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
            <p class="s4" style="padding-top: 1pt;padding-left: 21pt;text-indent: 0pt;text-align: left;">VALOR
            </p>
        </td>
    </tr>
    @foreach ($recibosTipo2 as $recibo2)
        <tr style="height:17pt">
            <td
                style="width:58pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br /> {{ $recibo2->numero_recibo }} </p>
            </td>
            <td
                style="width:66pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibo2->descricao }}</p>
            </td>
            <td
                style="width:56pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
            ...
            <td
                style="width:258pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibo2->nome }}</p>
            </td>
            <td
                style="width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibo2->valor }}</p>
            </td>
        </tr>
        @endforeach
        <tr style="height:24pt">
            ...
            <td
                style="width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibosTipo2Total }}</p>
            </td>
        </tr>
</table>
<p style="text-indent: 0pt;text-align: left;"><br /></p>
<p style="padding-left: 91pt;text-indent: 0pt;line-height: 18pt;text-align: center;"><span
        style=" color: #FFF; font-family:Arial, sans-serif; font-style: normal; font-weight: bold; text-decoration: none; font-size: 16pt;">TOTAL
        GERAL DE ENTRADAS</span></p>
<p style="padding-left: 5pt;text-indent: 0pt;text-align: left;" />
<p style=" text-align: center; text-indent: 0pt;text-align: left;"><br /></p>
<table style="text-align: center; border-collapse: collapse; margin: 0 auto;" cellspacing="0">
    <tr style="height:24pt">
        <td style="width:512pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
            colspan="4" bgcolor="#FF0000">
            <p class="s3"
                style="padding-left: 221pt;padding-right: 219pt;text-indent: 0pt;line-height: 23pt;text-align: center;">
                SAÍDAS</p>
        </td>
    </tr>
    <tr style="height:15pt">
        <td style="width:124pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
            bgcolor="#F4AF83">
            <p class="s6" style="padding-left: 39pt;text-indent: 0pt;text-align: left;">Nota Fiscal</p>
        </td>
        <td style="width:56pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
            bgcolor="#F4AF83">
            <p class="s6" style="padding-left: 18pt;text-indent: 0pt;text-align: left;">Data</p>
        </td>
        <td style="width:258pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
            bgcolor="#F4AF83">
            <p class="s6" style="padding-left: 112pt;padding-right: 110pt;text-indent: 0pt;text-align: center;">
                Nome</p>
        </td>
        <td style="width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt"
            bgcolor="#F4AF83">
            <p class="s6" style="padding-left: 25pt;padding-right: 23pt;text-indent: 0pt;text-align: center;">
                Valor</p>
        </td>
    </tr>
    @foreach ($recibosSaida as $saida)
        <tr style="height:17pt">
            <td
                style=" text-align:center width:124pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $saida->nfc }}</p>
            </td>
            <td
            ...
            <td
                style=" text-align:center width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: left;"><br />{{ $saida->valor }}</p>
            </td>
        </tr>
    @endforeach
    <tr style="height:24pt">
        ...
        <td
            style=" text-align:center width:74pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
            <p style="text-indent: 0pt;text-align: left;"><br />{{ $recibosSaidaTotal }}</p>
        </td>
    </tr>
</table>
<p style="text-indent: 0pt;text-align: left;"><br /></p>
<p style="padding-top: 3pt;padding-left: 72pt;text-indent: 0pt;text-align: left;"><span
        style=" color: #FFF; font-family:Arial, sans-serif; font-style: normal; font-weight: bold; text-decoration: none; font-size: 12pt;">SALDO
        FINAL DOS 30%</span></p>
<p style="padding-left: 185pt;text-indent: 0pt;text-align: left;" />
<p style="text-indent: 0pt;text-align: left;"><br /></p>
<p style="padding-left: 91pt;text-indent: 0pt;line-height: 20pt;text-align: center;"><span
        style=" color: #FFF; font-family:Arial, sans-serif; font-style: normal; font-weight: bold; text-decoration: none; font-size: 18pt;">TOTAL
        GERAL (Entradas - Saídas)</span></p>
<p style="padding-left: 5pt;text-indent: 0pt;text-align: left;" />
<p style="text-indent: 0pt;text-align: left;"><br /></p>
<p class="s7" style="padding-left: 6pt;text-indent: 0pt;line-height: 1pt;text-align: left;"> </p>
<p style="padding-left: 91pt;text-indent: 0pt;text-align: center;">ARRECADADOR DIRIGENTE</p>
<p style="text-indent: 0pt;text-align: left;"><br /></p>
<p style="padding-left: 185pt;text-indent: 0pt;line-height: 1pt;text-align: left;" />
<p style="padding-left: 123pt;text-indent: 0pt;text-align: center;">SUPERVISOR</p>
